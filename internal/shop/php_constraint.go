...
// returned when the version cannot be found or has no PHP requirement.
...
// the given version in the provided release list. Dev branches (e.g. dev-trunk) are
// looked up like any other version: the repository client fetches Packagist's dev
// metadata, so their constraint is usually known. nil is returned when the version
// cannot be found or has no PHP requirement.
